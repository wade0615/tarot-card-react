...
export default [
  ...
  },
  {
    ...
    order: 0,
    waiteExp:
      "關鍵詞​<br>理想主義，新的冒險，天真，決定，自發性，冒險，貴人相助，對新經驗的開放。​<br><br>愚者是一張潛力，新的開始和天真的卡片。一個成長的旅程或經歷的開始，他會變成誰，還是個謎。​<br>這張牌預示著冒險和新的機會在等待著。愚者是無憂無慮的，沒有恐懼和焦慮的負擔，即使他一隻腳踩在懸崖的邊緣，他似乎也不介意，即便他真的不知道前面是什麼。​<br>​<br>在解牌中，愚者是最能代表求知者自己的卡片，塔羅牌的故事裡也是愚者自身的旅程，有時愚者也可能代表另一個人。當愚者出現在關係解牌中的未來位置時，它可能預示著一個年輕，無憂無慮，有趣或不負責任的新戀人。魔術師和愚者在一起是偉大的，因為他們是一個時代的後裔，讓你生命中的力量幫助你完成大事，而不必失去你存在的輕盈。這個愚者與天真結合在一起。​<br>當愚者與旅行意象強烈的&nbsp;權杖八&nbsp;或&nbsp;權杖二&nbsp;一同出現&nbsp;，表明了一個明智的時間，該走到未知的地方去擁抱新的冒險。與此同時，要提防不負責任，過於瘋狂的計劃和魯莽。根據牌陣中的其他卡片，訊息可以是溫和的，比如告誡你放下焦慮，也可以是嚴厲的，比如警告你自己或他人的魯莽或精神不穩定。​<br>​<br>逆位關鍵詞​<br>愚蠢，魯莽，不守規矩，盲信，沉迷享樂，粗心大意，過於在意他人想法​<br>​<br>在逆位來說，他警告你注意那些未完成或放棄的項目，不安全和懷疑，或者已經(或將要)做出愚蠢或不負責任的選擇。在極端的情況下，愚者可能會解讀為瘋子，精神疾病或癡呆。​<br>當你看到&nbsp;惡魔&nbsp;和&nbsp;愚者&nbsp;在一起解牌的時候，要非常小心那些看起來似乎很有趣、無憂無慮的生活很快就會變成債務、上癮和破壞的關係。​<br>​<br>關聯<br>占星術：無​<br>數字：0，22，33",
    lineStriderExp:
  ...
  },
  {
    ...
    lineStriderExp:"關鍵詞<br>直覺，寧靜，夢想，秘密，誠實，平衡，親和，靈性，內在探索<br><br>女祭司是像徵通過夢境與潛意識聯繫的一張牌。代表智慧、知識、寧靜和理解，她是無意識領域的守護者，這張卡片出現在你應該依靠你的夢想和直覺來尋求指引的時候。<br>你需要傾聽並相信你內心的聲音。在你的生命中可能有一些失去平衡的領域，需要無意識領域的智慧，對於最近的困境，答案將來自你的直覺和內心的聲音。<br>如果一個男性的詢問者抽出這張牌，信息可能會特別清楚：如果你想要成功和進步，要特別注意你內在柔軟的一面或女性的能量。對於兩性雙方來說，宇宙女性的聲音掌握著你所尋求的答案。如果在牌陣中看到一個女祭司被聖杯卡片包圍，則更明確的指出問卜者完全處於潛意識和直覺的領域。<br>如果問卜者的問題是關於你生活中的一個問題，聖杯一&nbsp;與&nbsp;女祭司組合強烈地暗示問題是在感情領域，人們彼此之間的聯繫和他們的情感，而不是現實因素。女祭司&nbsp;與&nbsp;魔術師&nbsp;同時出現，牌陣可能表明在看不見的領域中存在著深刻的力量，你可以調動這些力量來達到你的目標。在單牌牌陣中她也表示即將發生的變化，如果你允許她指導你，你的直覺和創造力就會增強。這張牌同時也有藝術家，詩人和作家的意象。<br><br>逆位關鍵詞<br>精神壓抑，焦慮，猶豫不定，緊張，神經質，封閉自我，不與人溝通，無法傾聽內在聲音，或知道但無法轉化為行動<br><br>女祭司的逆位，表示一個與你的直覺和內在聲音，或與你的女性力量斷開的狀態，可能以任何形式呈現出來。忽視她將會使妳遭受挫敗的體驗，你需要的答案是潛意識的，內在柔軟的領域。這張牌可能在警告你不要依賴外部聲音或意見。女祭司建議你花時間獨處，重新與你自己的聲音連接。<br>如果牌陣上出現&nbsp;隱士&nbsp;或另一張要求問卜者尋求獨處的卡片，內在探索的含義將更為強烈。還可以指出問卜者可能隱藏某些議題或工作上的拖延。<br><br>關聯<br>占星術：處女座，巨蟹座<br>數字：2"
  },
  {
    name: "Judgement 審判",
    img: judgement,
